...
namespace HIKARI::MESHRENDERER {
    ...
    void MeshTraditionalIndirectOwner::OwnedStream::Clear() {
        records.clear();
    ...
    bool MeshTraditionalIndirectOwner::OwnedStream::CopyFrom(
    ...
    MeshTraditionalIndirectOwner::OwnedStream::GetView() const {
    ...
    void MeshTraditionalIndirectOwner::OwnedStream::AttachTo(
